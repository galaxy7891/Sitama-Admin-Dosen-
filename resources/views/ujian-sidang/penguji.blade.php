...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Input Nilai Ujian Sidang Akhir</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <form action="{{ route('ujian-sidang.storePenguji', $infoMhs->ta_sidang_id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <select name="unsur[{{ $nilai->nilai_id }}]" class="form-control js-example-basic-single col-2">
                                        @for($i=100; $i>=1; $i--) 
                        ...
                        <div class="card-footer">
                            <a class="btn btn-info confirm-nilai mr-2"><i class="fa fa-save"></i>
                                Simpan</button>
                            <a href="{{ route('ujian-sidang.index') }}" class="btn btn-danger"><i class="fas fa-times"></i>
                                Batal</a>
                        </div>
                    </form>
                </div>
