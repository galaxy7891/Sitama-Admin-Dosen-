...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Revisi Ujian Sidang Akhir</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="{{ asset('storage/draft_revisi/' . $infoMhs->revisi_file) }}" target="_blank">{{ $infoMhs->revisi_file }}</a>
                                @else
                                <p class="m-0">Tidak Ada Revisi</p>
                                @endif
                            </div>
                        </div>
                    </form>
